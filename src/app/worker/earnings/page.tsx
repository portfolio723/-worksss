    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <main className="content-area">
        ...
        <section>
          ...
          <div className="space-y-3">
            {history.map((item) => (
              <div key={item.id} className="flex items-center gap-4 p-4 bg-white rounded-xl shadow-sm">
                <div className={`p-2 rounded-full ${item.type === 'Income' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
                ...
                <div className={`text-sm font-bold ${item.type === 'Income' ? 'text-green-600' : 'text-foreground'}`}>
