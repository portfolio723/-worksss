      ...
      <main className="content-area max-w-lg mx-auto">
        <div className="flex flex-col items-center mb-8 pt-4">
          <div className="relative mb-4">
            ...
            <Button size="icon" className="absolute -bottom-2 -right-2 h-10 w-10 rounded-2xl bg-primary shadow-lg border-4 border-background font-medium">
          ...
          <TabsContent value="details" className="space-y-6">
            <Card className="p-6 bg-white border-border/50 shadow-sm rounded-2xl">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button variant="link" className="text-primary h-auto p-0 text-xs font-medium">Edit</Button>
              </div>
            ...
            <Card className="p-6 bg-white border-border/50 shadow-sm rounded-2xl">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button variant="link" className="text-primary h-auto p-0 text-xs font-medium">Manage</Button>
              </div>
            ...
            <div className="space-y-2">
              ...
              <Button variant="ghost" className="w-full justify-between h-14 bg-white border border-border/30 shadow-sm rounded-2xl px-6 group hover:bg-secondary font-medium">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-bold tracking-tight">Privacy & Security</span>
                </div>
                <ChevronRight className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" />
              </Button>
              <Button 
