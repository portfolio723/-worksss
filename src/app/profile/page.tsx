...
function ProfileContent() {
  ...
  return (
    <div className={isWorker ? "worker-theme min-h-screen bg-background pb-20" : "hirer-theme min-h-screen bg-background pb-20"}>
      <TopNav />
        ...
        <Tabs defaultValue="details" className="w-full">
          ...
          <TabsContent value="settings" className="space-y-4">
            <div className="space-y-2 pb-10">
              <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1 mb-2">Security & Privacy</h3>
              ...
              <Button 
                variant="ghost" 
                className="w-full justify-between h-14 bg-white border-none shadow-sm rounded-2xl px-6 text-destructive hover:text-destructive hover:bg-destructive/5 font-medium mt-4"
